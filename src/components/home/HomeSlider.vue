          ...
          <div class="relative swiper-slide" v-for="img in pictures" :key="img.src">
            ...
            <div
              ...
              <article
                ...
                <!-- Precios -->
                <div class="flex items-center justify-center gap-2 space-x-3">
                ...
                <div class="flex items-center mt-4 space-x-2 text-sm text-gray-600 font-Poppins">
...
const pictures = [
  ...
  },
  {
    ...
    diameter: '23.5cm',
    height: '9.6cm',
    img: 'https://i.ibb.co/stMKN0v/circle4-removebg-preview.png',
  },
  {
  ...
  },
  {
    ...
    diameter: '25cm',
    height: '9.5cm',
    img: 'https://i.ibb.co/KDTHTPF/circle6-removebg-preview.png',
  },
  {
    src: 'https://i.ibb.co/sq5SLzD/78274e89-4653-47ff-a923-e7fb415a17d9.jpg',
    alt: 'Image 1',
  ...
  },
  {
    ...
    diameter: '15.5cm',
    height: '16cm',
    img: 'https://i.ibb.co/BwphY0z/circle7-removebg-preview.png',
  },
  {
    src: 'https://i.ibb.co/GVFZTT7/a5694e6f-848e-4c86-9a55-67178032ac39.jpg',
    alt: 'Image 1',
